...
def test_task_result_splitter_emits_executor_output_with_parent_context_and_task_result_with_child_context() -> None:
    context_store, persistence = _context_store_with_persistence()
    splitter = TaskResultSplitter[DummyExecutorPayload, DummyExecutorOutput](NodeId("task-result-splitter"))
    ...
    assert executor_output_event.payload == task_result.executor_output
